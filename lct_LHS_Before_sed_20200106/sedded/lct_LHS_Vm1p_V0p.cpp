...
void FMatrixOrthogonalizer::FormLHS_Vm1p_V0p(PairList &RActList, PairList &TActList, const orz::DTensor &d1, const orz::DTensor &d2, const orz::DTensor &d3, DensityPack &dPack,
...
orz::DTensor &Jint_aaav_caav_0_ = (*dPack["Jint_aaav_caav_0_"]);
{
double t_trans=0.0;
#ifdef _PROFILE_LHS
std::cout << boost::format("%80s") % "@S2(P,a) <<= +1 @Jint_aaav_caav_0_(P,P0,c0) @T(0')(c0,a,P0)";
#endif
high_resolution_clock::time_point t1 = high_resolution_clock::now();
// @S2(P,a) <<= +1 @Jint_aaav_caav_0_(P,P0,c0) @T(0')(c0,a,P0)
  ...
  for(auto &&P0 : irange(0L, Nrho0p)){
    ...
    for(auto &&c0 : irange(0L, _Ndocc)){
      for(auto &&a : irange(0L, _Nvirt)){
        S2.cptr()[a] += Jint_aaav_caav_0_.cptr()[P*Jint_aaav_caav_0_.shape(1)*Jint_aaav_caav_0_.shape(2)+P0*Jint_aaav_caav_0_.shape(2)+c0] * U2.cptr()[c0*U2.shape(1)+a];
      }//a
    }//c0
  }//P0
  R2.PutTensor(P, S2);
