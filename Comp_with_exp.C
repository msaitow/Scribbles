...
///   float Aaniso_3[nx] = {0.3824,0.3179,6.2785 ,8.7344 ,7.9097 ,5.7116 ,5.1611 };
   ...
   const Int_t nx = 8;
   string func[nx]    = {"Default1","Default2","canonical CCSD","B3LYP","PBE","M06-2X","CAM-B3LYP","B2PLYP"};
   float Aiso[nx]     = {15.024,14.482,14.121,16.343,27.435,50.964,17.826,19.966};
   float Aaniso_1[nx] = { 5.392, 5.408, 5.549, 7.250, 7.727, 6.121, 6.917, 6.977};
   float Aaniso_2[nx] = { 4.369, 4.359, 4.499, 5.623, 6.155, 5.472, 5.716, 5.991};
   float Aaniso_3[nx] = { 7.322, 7.323, 7.308, 9.710, 9.378, 9.113,10.047, 9.851};
   TCanvas *cb = new TCanvas("cb","cb",600,400);
   cb->SetGrid();
   gStyle->SetHistMinimumZero();
   TH1F *h1b = new TH1F("h1b","Average Absolute Errors from Exp. in MHz",nx,0,nx);
   h1b->SetFillColor(4);
   h1b->SetBarWidth(0.2);
